...
STATUS_FILE="${STATUS_FILE:-$RUNLOG_DIR/final_sdwpf_gpu_only_${STAMP}.status}"
LOG_FILE="${LOG_FILE:-$RUNLOG_DIR/final_sdwpf_gpu_only_${STAMP}.log}"
...
run_step "SDWPF_GPU_BENCHMARK" \
  python safe_tcn_lab/run_benchmark.py \
    ...
    --benchmark_root safe_tcn_lab/final_runs/benchmark_sdwpf_gpu_only

run_step "SDWPF_GPU_SWEEP" \
  python safe_tcn_lab/run_transfer_sweep.py \
    ...
    --sweep_root safe_tcn_lab/final_runs/sweep_sdwpf_gpu_only
